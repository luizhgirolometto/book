        ...
        <div class="row join-main">
            <div class="col-md-6">
                <div class="join">
                    ...
                    <h4><?php if($this->lang->line('login_sigup_A3')){ ?><?php echo $this->lang->line('login_sigup_A3'); }else{ ?>Find a doctor and book an appointment <?php } ?><br></h4>
            ...
            <div class="col-md-6">
                <div class="join-1">
                    ...
                    <h4><?php if($this->lang->line('login_sigup_B2')){ ?><?php echo $this->lang->line('login_sigup_B2'); }else{ ?>Quicker way for your patient to schedule an appointment.<?php } ?> <br>
                    </h4>
