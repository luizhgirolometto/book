            ...
            <div class="col-lg-9 col-xs-8 col-sm-12 header-sgnin">
                <div class="signin">
                    <ul>
					    <?php if ($this->session->userdata('frontend_logged_in')){
							...
							?>
							<li><a href = "<?php echo base_url(); ?>Welcome"><img src="<?php echo base_url(); ?>assets/images/patient-login/m-1.png" />Olá,<?php echo $username; ?> </a></li>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav nav-head animated fadeInDown">
                        ...
                        <li><a href = "<?php echo base_url(); ?>General/aboutus"><?php if($lgaboutus){ echo $lgaboutus; }else { ?>Sobre nós<?php }?></a></li>
