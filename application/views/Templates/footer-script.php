...
<!---->	
    ...
    <!-- Plugin JavaScript -->
    <script src="<?php echo base_url(); ?>assets/css/vendor/jquery-easing/jquery.easing.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/css/vendor/magnific-popup/jquery.magnific-popup.min.js"></script>

    <!-- Contact Form JavaScript -->
    <script src="<?php echo base_url(); ?>assets/js/head/jqBootstrapValidation.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/head/contact_me.js"></script>

    <!-- Custom scripts for this template -->
    <script src="<?php echo base_url(); ?>assets/js/head/freelancer.min.js"></script>
