				   ...
				   <div class="form-group has-feedback">
				   	  ...
				   	  <div class="form-group has-feedback">
						  ...
						  <div class="form-group has-feedback">
                            ...
                            <input type="text" name="lgfdviewprofile" value="<?php echo $lgfdviewprofile; ?>" placeholder="Ver Perfil" class="form-control required regcom" >
                            <span class="glyphicon  form-control-feedback"></span>
                          </div>
						  <div class="form-group has-feedback">
                            <label for="exampleInputEmail1"> Agende Online</label>
                            <input type="text" name="lgfdbookonline" value="<?php echo $lgfdbookonline; ?>" placeholder="Agende Online" class="form-control required regcom" >
                            <span class="glyphicon  form-control-feedback"></span>
                          </div>
						  <div class="form-group has-feedback">
