            ...
            <div class="box">
              ...
              <div class="form-group has-feedback">
						   ...
						   <div class="form-group has-feedback">
                            ...
                            <input type="text" name="lang['hospitalprofile_slide_A9']" placeholder="Ver Perfil" class="form-control required regcom"  required="" >
                            <span class="glyphicon  form-control-feedback"></span>
                          </div>
						   <div class="form-group has-feedback">
                            <label for="exampleInputEmail1">Agende Online</label>
                            <input type="text" name="lang['hospitalprofile_slide_A10']" placeholder="Agende Online" class="form-control required regcom"  required="" >
                            <span class="glyphicon  form-control-feedback"></span>
                          </div>
						   <div class="form-group has-feedback">
